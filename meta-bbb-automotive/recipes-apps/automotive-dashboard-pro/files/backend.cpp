...
{
    // --- 1. CONFIGURATION DU SOCKET (POUR SIMULATION PYTHON) ---
    m_server = new QLocalServer(this);
    QString socketPath = "/tmp/car_socket";

    // Nettoyage de l'ancien socket si l'application a été mal fermée
...
// Slot : Appelé quand le script Python se connecte
...
// Slot : Analyse les messages reçus (Format attendu : "V:120|R:3500")
void Backend::readSocketData()
{
    ...
    QString strData = QString::fromUtf8(data).trimmed(); // .trimmed() enlève les \n ou espaces
